          ...
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="about-box ab-padding">
                ...
                <p><b>NJ Rental</b> is one stop for all users to search for thier perfect home or post thier property available for rent. Chat with the owner get every little details checked off your check
                  ...
                  </p> <div className="about-right-desc">
                  <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" >
                      <div className="about-box">
                        ...
                        <div className="about-inner-data">
                          ...
                          <p>
                            Etiam commodo ex nec erat tempor varius. Nunc rutrum pretium nunc in malesuada.
                          </p>
                        </div>
                      </div>
                    </div>
