            ...
            <section className="home-section1">
                <div className="row">
                    <div className="column">
                        ...
                        <p className="home-p-1"><b>NJ Rental</b> is one stop for all users to search for thier perfect home or post thier property available for rent. Chat with the owner get every little details checked off your check list for a perfect home. We make finding your perfect home in any city all across New Jersey easy.Our suite of online services enables clients to analyze, interpret and gain unmatched insight on commercial property values, market conditions and current availabilities.</p>
            ...
            <section className="home-section2">
                <div className="row">
                    <div className="column-1">
                        ...
                        <p className="home-p-1">Select from major cities accross New Jersey and find the perfect place to rent. Check out all the amemnnities in and arround the place that suits your idea of a perfect place. NJRental makes finding home easy with: </p>
